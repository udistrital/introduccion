...
export const environment = {
  ...
  //PERSONA_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/apitest/v1',
  ...
  INSCRIPCION_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/apitest/v1',
  ...
  //PRUEBA_SERVICE: 'http://localhost:8080/v1/usuario'
  PRUEBA_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/apitest/v1',
};
